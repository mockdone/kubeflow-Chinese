...
module.exports = {
    ...
    devServer: {
        ...
        proxy: {
            '/api': 'http://10.18.3.22',
            '/jupyter': {
                target: 'http://10.18.3.22/api/v1/namespaces/kubeflow/services/jupyter-web-app-service:80/proxy',
                pathRewrite: {'^/jupyter': ''},
            },
            '/metadata': {
                target: 'http://10.18.3.22/api/v1/namespaces/kubeflow/services/metadata-ui:80/proxy',
                pathRewrite: {'^/metadata': ''},
            },
            '/notebook': {
                target: 'http://10.18.3.22/api/v1/namespaces/',
                pathRewrite: {
                    '^/notebook/(.*?)/(.*?)/(.*)':
            ...
            '/pipeline': {
                target: 'http://10.18.3.22/api/v1/namespaces/kubeflow/services/ml-pipeline-ui:80/proxy',
